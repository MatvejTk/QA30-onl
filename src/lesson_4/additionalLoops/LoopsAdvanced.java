package lesson_4.additionalLoops;

public class LoopsAdvanced {
    public static void main(String[] args){
        // Advanced LOOPS

        // Если нам нужно банально записывать, обрабатывать данные, притворять в жизнь больше кода
        // То мы используем классические массивы: do while, while, for

        // Но если нам нужно обеспечить защиту данных и просто что-то читать
        // То мы используем т.н. усиленный вариант for (enhanced for)
        advancedFor();
    }
