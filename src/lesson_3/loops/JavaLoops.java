package lesson_3.loops;

public class JavaLoops {
    public static void main(String[] args){
        // Basic loops
        // Цикл это код, который будет повторяться определенное количество раз,
        // пока логическое условие не будет выполнено
    ...
    public static void setWhile(){
        ...
        while(numbers <=10){
            ...
            // В отличии от do while, где тело хотя бы раз выполнится,
            // здесь, если логическое условие уже нарушено, такого просто не может быть
            System.out.println(numbers);
            numbers++;
        }
    }
