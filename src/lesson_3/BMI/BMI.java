...
public class  BMI {
    ...
    // Формула такая Вес в КГ делить на Рост * Рост (186 = 1.86 * 186)
    ...
    public static void getBMIData(){
        ...
        // Создание любого объекта происходит через ключевое слово new
        ...
        // Сканнер у нас знает, что мы будет давать ему данные через клавиатуру
