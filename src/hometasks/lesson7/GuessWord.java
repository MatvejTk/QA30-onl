...
public class GuessWord {
    public static void main(String[] args){
        ...
        // 8. Если по буквам, проверить существует ли такая буква и вывести на экран какую букву отгадали
        // 8.1. Если букву не отгадали, сказать, что такой буквы нет и продолжить отгадывание
